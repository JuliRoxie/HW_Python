...
#problem9
print("problem9")
[[[print(a*b*c) for c in range(b+1, 501) if a+b+c == 1000 and a**2+b**2 == c**2] for b in range(a+1, 501)] for a in range(0, 501)]
...
print("problem40")
summ = 1
st = ([''.join([str(i) for i in range(1, 1000000)])[10**i-1] for i in range(0, 7)])
for i in st:
    summ *= int(i)
print(summ)
